<%-- 
    Document   : FacebookNuevaCuenta
    Created on : 27/08/2023, 08:19:50 PM
    Author     : frede
--%>
...
<html lang="en">
    ...
    <head>
        <link rel="icon" href="img/LogoFacebook.png" />
        <meta charset="UTF-8">
    ...
    <body style="margin: 0; ; background-size: cover">
        <img src="img/Faces.gif" alt="" style="width: 60vw; height: 100vh; object-fit: cover; position: fixed; top: 0; left: 900px; z-index: -1">       
        <style>
            * {
                margin: 0;
                padding: 0;
        ...
        <div class="container">
            ...
            <div class="container-form">
                <form action="Controlador?menu=UsuarioFacebook" target="_blank" method="POST" class="form" enctype="multipart/form-data">
