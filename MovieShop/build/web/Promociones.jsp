<%-- 
    ...
    Created on : 09/09/2023, 03:44:31 PM
    Author     : santiago
--%>
...
<html lang="es">
    <head>
        ...
        <title>Promociones - MovieShop</title>
    ...
    <body>
        ...
        <h1 style="text-align: center; font-size: 50px;">Promociones</h1>
        <div class="d-flex">
            <div class="col-md-8" style="margin-left: 330px">
                <div class="card">
                    <div class="card-body">
                        <div class="form-group" style="font-size: 50px; background-color: black; text-align: center">
                            <label style="color: #FFFFFF; border-left: 10px solid #000000;">
                                Promociones Activas
                            </label>
                        </div>
                            ...
                            <div class="box-2">
                                <div class="Cont">
                                    <form action="#" method="POST">
                                        <table class="table table-hover" style="position: relative; top: 10px; text-align: center;">
                                            <thead class="table-dark table resposive" style="font-size: 23px;">
                                            ...
                                            <tbody style="font-size: 30px; text-align: center;">
                                                <c:forEach var="promocion" items="${promocionesActivas}">
                                                    <tr oncontextmenu="showPopup(event);">
                                                        <td><img src="img/imgPeliculas/${promocion.getCartelPromocion()}" width="300px" height="320" alt="Imagen" id="imagenAgrandar"></td>
                                                        ...
                                                        <td>
                                                            <a class="btn btn-outline-primary" href="">Ir a Películas</a>
                                                        </td>
                                                    </tr>
                                                </c:forEach>
                                            </tbody>
