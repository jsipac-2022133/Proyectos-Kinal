<%-- 
    ...
    Created on : 18/07/2023, 08:03:07 PM
    Author     : Dario
--%>
...
<html>
    <head>
        ...
        <title>MovieShop - Tipo Tarjeta</title>
        <style>            
            .custom-alert {
                display: none;
                position: fixed;
        ...
        <div class="w-200 p-3 container w-100 bg-danger mt-5 rounded shadow" >
            <div class="row align-items-stretch">
                <div class="col d-none d-lg-block col-md-5 col-lg-5 col-xl-8 rounded">
                    <table class="table table-bordered border-primary">
                        <thead class="table-dark">
                            <tr>
                                <th>Id Tipo Tarjeta</th>
                                <th>Tipo Tarjeta</th>
                                <th>Acciones</th>
                            </tr>
                        </thead>
                        <tbody>  
                            <c:forEach var="tipoTarjeta" items="${tipoTarjetas}">
                                <tr>
                                    <td>${tipoTarjeta.getIdTipoTarjeta()}</td>
                                    <td>${tipoTarjeta.getTipoTarjeta()}</td>
                                    <td>
                                        <a class="btn btn-warning" href="Controlador?menu=TipoTarjeta&accion=Editar&idTipoTarjeta=${tipoTarjeta.getIdTipoTarjeta()}">Editar</a>
                                        <a class="btn btn-danger" href="Controlador?menu=TipoTarjeta&accion=Eliminar&idTipoTarjeta=${tipoTarjeta.getIdTipoTarjeta()}">Eliminar</a>
                                    </td>
                                </tr> 
                            </c:forEach>
                        </tbody>
                ...
                <div style="margin-top: 1px" class="col bg-white col-sm-4 rounded-end float-end">
                    ...
                    <h2 class="fw-bold text-center py-5">Tipo Tarjeta</h2>


                    <form action="Controlador?menu=TipoTarjeta" method="POST">
                        <div class="mb-4">
                            <label class="form-label">Tipo Tarjeta</label>
                            <input id="txt1" class="form-control" value="${tipoTarjetaEncontrado.getTipoTarjeta()}" name="txtTipoTarjeta">
                        </div>
                        <div style="padding-bottom: 15px">
                            <input id="btnEnviar" type="submit" name="accion" value="Agregar" class="btn btn-success">
                        </div>
                        <div style="padding-bottom: 15px">
                            <input id="btnActualizar" type="submit" name="accion" value="Actualizar" class="btn btn-secondary">
                        </div>
                    </form>
                </div>
            </div>
