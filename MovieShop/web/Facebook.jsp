<%-- 
    Document   : Facebook
    Created on : 24/08/2023, 12:09:05 AM
    Author     : frede
--%>
        ...
        <div class="container">
            ...
            <div class="container-form">
                <form action="Validar" method="POST" class="form">
                    <input type="text" name="txtUser" placeholder="Correo electronico o numero de telefono">
                    <input type="password" name="txtPass" placeholder="Contraseña">
                    <input type="submit" name="accion" value="Ingresar">
                    <div class="border"></div>
                    <button><a href="Controlador?menu=CuentaFacebook">Crear cuenta nueva</a></button>
                </form>
            </div>
        </div>
