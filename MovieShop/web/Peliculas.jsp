<%-- 
    Document   : Peliculas
    Created on : 24/08/2023, 01:10:18 AM
    Author     : frede
--%>
...
<html lang="es">
    <head>
        ...
        <title>Peliculas - MovieShop</title>
    ...
    <body>
        ...
        <header >
            ...
            <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel" style="height: 100%; width: 100%;">

                <div class="carousel-inner" style="height: 100%; width: 100%;">
                    <div class="carousel-item active">
                        <img src="img/imgCarrusel/Rocky.jpeg" autoplay muted loop style="height: 1000px; width: 100%;">
                        <div class="carousel-caption d-none d-md-block" >
                            <h1>GOZILLA II</h1>
                            <a href="Controlador?menu=InformacionPelicula&accion=Editar&idProducto=27" <button type="button" class="btn btn-outline-secondary">>Ver mas >></button></a>

                        </div>

                    </div>
                    <div class="carousel-item">
                        <img src="img/imgCarrusel/GuardianesDeLaGalaxia.jpeg" autoplay muted style="height: 1000px; width: 100%;">
                        <div class="carousel-caption d-none d-md-block" >
                            <h1 >GUARDIANES DE LA GALAXIA Vol.3</h1>
                            <a href="Controlador?menu=InformacionPelicula&accion=Editar&idProducto=10" <button type="button" class="btn btn-outline-secondary">>Ver mas >></button></a>
                        </div>
                    </div>
                    <div class="carousel-item">
                        <img src="img/imgCarrusel/Black_Adam.png" style="height: 1000px; width: 100%;">
                        <div class="carousel-caption d-none d-md-block">
                            <h1>Black Adam</h1>
                            <a href="Controlador?menu=InformacionPelicula&accion=Editar&idProducto=4" <button type="button" class="btn btn-outline-secondary">>Ver mas >></button></a>
                        </div>
                    </div>
                    <div class="carousel-item">
                        <img src="img/imgCarrusel/VENOM.jpeg" style="height: 1000px; width: 100%;">
                        <div class="carousel-caption d-none d-md-block">
                            <h1>VEMON</h1>
                            <a href="Controlador?menu=InformacionPelicula&accion=Editar&idProducto=22" <button type="button" class="btn btn-outline-secondary">>Ver mas >></button></a>
                        </div>
                    </div>
                </div>
        ...
        <section class="movies container">
                        ...
                        <div class="content">
                            <div class="custom-tooltip"> 
                                <a href="Controlador?menu=InformacionPelicula&accion=Editar&idProducto=${producto.getIdProducto()}">
                                    ...
                                    <span class="tooltiptext" >${producto.getSinopsis()}</span> 
                                </a>
                            </div>
            ...
            <div class="load-more">
                <a href="Controlador?menu=Historial&accion=Listar" style="text-decoration: none; color: inherit;">
                Historial
                </a>
            </div> 
        </section>
        ...
        <script>
            ...
            loadMoreBtn1.onclick = () => {
                ...
                for (var i = currentItem1; i < currentItem1 + 20; i++) {
                    if (boxes[i]) {
